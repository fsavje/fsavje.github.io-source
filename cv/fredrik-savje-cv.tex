...
\begin{document}
	...
	\begin{infolist}
		\infoitem{Harshaw, Sävje, Spielman\ \& Zhang\ (2023).\ \href{https://doi.org/10.1080/01621459.2023.2285474}{Balancing Covariates in Randomized Experiments with the Gram–Schmidt Walk Design}.\ \textit{Journal of the American Statistical Association}, in print.}
	...
	\begin{infolist}\infoitem{Planetary Solutions Project seed grant from the Climate Impact Innovation Fund and the Gordon Data and Environmental Sciences Research Grants, 2023--2024, USD 80,000,
			\sublistitem{with Megan Ayers and Luke Sanford.}}\infoitem{Best Paper Award at 2022 NeurIPS Workshop on Causal Machine Learning for Real-World Impact,
			\sublistitem{with Christopher Harshaw and Yitan Wang.}}\infoitem{Yale Junior Faculty Fellowship, 2019--2020.}\infoitem{\href{https://www.cambridge.org/core/membership/spm/about-us/awards/the-gosnell-prize}{Gosnell Prize for Excellence in Political Methodology, 2018},
			\sublistitem{with P.M. Aronow and Michael Hudgens.}}\infoitem{NSF Conference Grant, PolMeth Summer Meeting, 2015.}\infoitem{UK Causal Inference Meeting, 2015, conference grant.}\infoitem{Swedish International Development Cooperation Agency, 2013--2015, SEK 2,595,000,
			\sublistitem{with Niklas Bengtsson, Eva Mörk (PI) and Jonas Poulsen.}}\infoitem{The Jan Wallander and Tom Hedelius foundation, 2013--2014, SEK 321,000.}\infoitem{The Siamon foundation, 2013, conference grant.}
	\end{infolist}
	...
	\begin{singledatelist}
		\dateitem[2024]{Causal Working Group, Harvard University, scheduled.}
		\dateitem{Department of Economics, European University Institute, scheduled.}
		\dateitem{Department of Quantitative Theory and Methods, Emory University, scheduled.}
	...
	\begin{singledatelist}
		\dateitem[2024]{ENAR, Baltimore, scheduled.}
