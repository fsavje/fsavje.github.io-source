...
\begin{document}
	...
	\begin{infolist}
		...
		\infoitem{Faculty Fellow, Uppsala Center for Fiscal Studies, Uppsala University.}
	\end{infolist}
	...
	\begin{datelist}
		\dateitem[2022--2024]{Faculty Member, Institute for the Foundations of Data Science, Yale University.}
		\dateitem[2017--2024]{Faculty Fellow, Institution for Social \& Policy Studies, Yale University.}
	\end{datelist}
	...
	\begin{infolist}
		\infoitem{Aronow, Robins, Saarinen, Sävje\ \& Sekhon\ (2025).\ \href{https://arxiv.org/abs/2108.11342}{Nonparametric identification is not enough, but randomized controlled trials are}.\ \textit{Observational Studies}, in print.}
	...
	\begin{infolist}
		...
		\infoitem{Econometric Theory (grad). Spring 2025.}
	\end{infolist}
	...
	\begin{infolist}
		\infoitem{Thomas Crol, Economics, Uppsala, current.}
	...
	\subsection*{Honors thesis advisor}

	\begin{infolist}
		\infoitem{Villem Wettermark, Economics, Uppsala, 2024.}
	\end{infolist}

	\subsection*{Dissertation grading committee member}

	\begin{infolist}
		\infoitem{Mohammad Ghasempour, Statistics, Umeå University, 2024.}
		\infoitem{Lilla Orr, Political Science, Yale University, 2021.}
		\infoitem{John Ternovski, Political Science, Yale University, 2021.}
		\infoitem{Costanza Tortù, Eocnomics, IMT School for Advanced Studies Lucca, 2020.}
	\end{infolist}
