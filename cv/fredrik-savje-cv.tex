...
\begin{document}
	...
	\begin{infolist}
		...
		\infoitem{Aronow\ \& Sävje\ (2019).\ \href{http://fredriksavje.com/papers/TBOW-review.pdf}{Review: The Book of Why}.\ \textit{Journal of the American Statistical Association}, in print.}
	\end{infolist}
	...
	\begin{singledatelist}
		...
		\dateitem[2019]{Causal Learning with Interactions Conference, Cemmap, London, scheduled.}
